...
<!-- Mirrored from demos.creative-tim.com/light-bootstrap-dashboard-pro/examples/pages/user.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 01 Mar 2017 13:33:45 GMT -->
<head>
	<meta charset="utf-8" />
    ...
    <meta itemprop="image" content="bootstrap/s3.amazonaws.com/creativetim_bucket/products/34/original/opt_lbd_pro_thumbnail.jpg">
    <!-- Twitter Card data -->
    ...
    <meta name="twitter:image" content="bootstrap/s3.amazonaws.com/creativetim_bucket/products/34/original/opt_lbd_pro_thumbnail.jpg">
    ...
    <meta property="og:image" content="bootstrap/s3.amazonaws.com/creativetim_bucket/products/34/original/opt_lbd_pro_thumbnail.jpg"/>
    ...
    <!--     Fonts and icons     -->
    <link href="bootstrap/maxcdn.bootstrapcdn.com/font-awesome/latest/css/font-awesome.min.css" rel="stylesheet">
...
<div class="wrapper">
    <div class="sidebar" data-color="orange" data-image="bootstrap/assets/img/full-screen-image-3.jpg">
        <!--
    	...
    	<div class="sidebar-wrapper">
            ...
            <div class="user">
                <div class="photo">
                    <img src="bootstrap/assets/img/default-avatar.png" />
                </div>
                <div class="info">
            ...
            <ul class="nav">
                ...
                <li class="active">
                    <a data-toggle="collapse" href="#pagesExamples" area-expanded="true">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card card-user">
                            <div class="image">
                                <img src="bootstrap/assets/img/full-screen-image-3.jpg" alt="..."/>
                            </div>
                            <div class="content">
                                <div class="author">
                                     <a href="#">
                                    <img class="avatar border-gray" src="bootstrap/assets/img/default-avatar.png" alt="..."/>
        ...
        <ul class="dropdown-menu">
            ...
            <li>
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                    <img src="bootstrap/assets/img/full-screen-image-1.jpg">
                </a>
            </li>
            <li>
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                    <img src="bootstrap/assets/img/full-screen-image-2.jpg">
                </a>
            </li>
            <li class="active">
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                    <img src="bootstrap/assets/img/full-screen-image-3.jpg">
                </a>
            </li>
            <li>
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                    <img src="bootstrap/assets/img/full-screen-image-4.jpg">
                </a>
            </li>
...
<!--   Core JS Files and PerfectScrollbar library inside jquery.ui   -->
    ...
    <script>
      ...
      })(window,document,'script','bootstrap/www.google-analytics.com/analytics.js','ga');
